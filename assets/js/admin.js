jQuery(document).ready(function ($) {
	...
	$(document).delegate('.qmean-open-modal','click',function(e){
		 e.preventDefault();
		 $('body').append('<div class="qmean-modal"><div class="qmean-modal-inner"></div></div>');
		 var t = $(this);
		...
		$(document).delegate('.qmean-modal,.qmean-close-modal','click',function(e){
			if(!$(e.target).hasClass('qmean-modal') && !$(e.target).hasClass('qmean-close-modal')){
				return false;
			}
			$('.qmean-modal').remove();
		});
