...
<div class="wrap qmean-dashboard">
  ...
  <div class="qmean-dashboard-report">
    ...
    <div class="qmean-dashboard-search postbox">
      <input class="qmean-search-keywords-input" placeholder="<?php _e('Type the keyword to filter the results. Then hit enter...','qmean');?>"/>
    </div>
