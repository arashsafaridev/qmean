        ...
        <div class="inside qmean-settings">
            <div class="postbox">
              ...
              <h2><?php _e('Essential Setup','qmean');?></h2>
                <table class="form-table">
                  ...
                  <tr valign="top">
                    <th scope="row"><?php _e('Submit After Click','qmean');?></th>
                    <td>
                      <select name="qmean_submit_after_click">
          ...
          button_style: CSS stlye like "padding: 0 0 15px 0; background-color:#1a1a1a"
                ...
                <table class="form-table">
                  ...
                  <tr valign="top">
                    <th scope="row"><?php _e('Merge Searched Queries','qmean');?></th>
                    <td>
                      <select name="qmean_merge_previous_searched">
